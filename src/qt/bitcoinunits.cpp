...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AKUYA");
    case mBTC: return QString("mAKUYA");
    case uBTC: return QString::fromUtf8("μAKUYA");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("AKUYAs"));
    case mBTC: return QString(QObject::tr("Milli-AKUYAs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-AKUYAs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
